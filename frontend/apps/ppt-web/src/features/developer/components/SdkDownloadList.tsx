...
import type { SdkLanguageInfo } from '../types';
    ...
    <div className="p-6 bg-white rounded-lg border shadow-sm">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">via {language.packageManager}</p>
        </div>
      </div>
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className={`px-3 py-2 rounded-md transition-colors ${
              isCopied ? 'bg-green-600 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'
            }`}
          >
            {isCopied ? (
