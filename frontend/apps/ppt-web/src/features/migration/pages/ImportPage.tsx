...
export function ImportPage() {
  ...
  // Get data from API responses - cast to component types (types are compatible)
  ...
  // Handle file upload completion (receives preview data from FileUploader)
    ...
    (job: ImportJobHistoryItem) => {
      retryImport.mutate(
        { jobId: job.id },
        {
          ...
          onError: (err) => {
            alert(`Failed to retry import: ${err.message}`);
          },
        }
      );
    },
